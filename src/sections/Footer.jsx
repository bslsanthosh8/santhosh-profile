...
function Footer() {
  ...
  return (
    <footer className="max-w-lg pb-4 text-sm sm:pb-0">
      <p className="leading-relaxed tracking-wide text-gray-400">
        From code to pixels, brought to life with{" "}
        <a
          href="https://react.dev/"
          className="group relative font-medium text-white hover:text-accent focus-visible:text-accent"
          target="_blank"
        ...
        by Santhosh Bayyavarapu. Adapted with {heartSVG} from India -{" "}
